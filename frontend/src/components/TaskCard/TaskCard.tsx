                ...
                {editing ?
                    <form action="" className={`flex p-5`} onSubmit={(e) => { handleSubmit(e) }}>
                        <div className="flex flex-col w-full box-border pl-3 pr-4">
                            ...
                            <textarea value={desc} onChange={(e) => { setDesc(e.currentTarget.value); checkHeight() }} name='description' placeholder='descripcion' ref={ref} className={`${utils.noscrollbar} border-b  border-black focus:outline-none box-border p-1 h-auto resize-none bg-transparent`} rows={1} />
                        </div>
